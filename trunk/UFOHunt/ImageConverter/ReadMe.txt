========================================================================
    ダイナミック リンク ライブラリ: ImageConverter 
    プロジェクトの概要
========================================================================

この ImageConverter DLL は、AppWizard により作成されました。  

このファイルには、ImageConverter 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

ImageConverter.vcxproj
...
ImageConverter.vcxproj.filters
