========================================================================
    アプリケーション: ImageConverterTest プロジェクトの概要
========================================================================

この ImageConverterTest アプリケーションは、AppWizard により作成されました。  

このファイルには、ImageConverterTest 
アプリケーションを構成する各ファイルの内容の概要が含まれています。

ImageConverterTest.vcxproj
...
ImageConverterTest.vcxproj.filters
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、ImageConverterTest.pch 
